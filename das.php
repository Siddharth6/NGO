...
<html>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="php/settings.php">message</a>   
                    </li>
                    <li>
                        <a href="php/join_users.php">New Reqest</a>   
                    </li>
                    <li>
                        <a href="php/galley_admin.php">Your Gallery</a>   
                    </li>
    ...
    <!-- action bar -->
                    ...
                    <div class="image" style="display:none;">
                        ...
                        <form action="php/img_admin.php" method="post" enctype="multipart/form-data">
