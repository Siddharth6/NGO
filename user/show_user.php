...
<tbody>
  ...
  <!-- populate table from mysql database -->
            ...
            <tr>
                ...
                <td><a href="<?php echo "update.php?id=".$row['id'];?>" class="btn btn-outline-primary " role="button" aria-pressed="true">Update</a></td>
                <td><a href="<?php echo "delete.php?id=".$row['id'];?>" class="btn btn-outline-danger" onclick="return dele()" role="button" aria-pressed="true">Delete</a></td>
            <?php endwhile;?>
        </tbody>
</table>
</form>
