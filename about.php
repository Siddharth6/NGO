...
<div class="container pt-5">
    ...
    <div class="row pt-5">
        <div class="col-6">
        <p class="card-text"> <img class="card-img-top" src="img/WhatsAppImage2020-06-25at17.03.441.jpeg" style="width:60%;height:50%;" alt="Card image cap"></p>
        </div>
        <div class="col-6">
        <div class="card border-success " style="max-width: 28rem;">
        <div class="card-header text-captalize">Smt. Saroj Singh</div>
        <div class="card-body text-dark">
            <h5 class="card-title">Founder & President || Avadh Group </h5>
            <hr>
            <p class="card-text">
            Our NGO has played a crucial role in helping the needy in society. We care and provide education to the
             children living in the SLUMS Area and even providing education to those people who are unable to go to school. 
